  ...
  return (
    <div className="min-h-screen bg-ash-50 dark:bg-ash-950 flex flex-col items-center justify-center px-4 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-flame-500/10 rounded-full blur-[120px] dark:bg-flame-600/5" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-ember-500/10 rounded-full blur-[120px] dark:bg-ember-600/5" />
      </div>
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-10 transition-all duration-700 animate-in fade-in slide-in-from-top-4">
          <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-flame-600 to-flame-400 text-white font-bold text-2xl shadow-xl ring-4 ring-white dark:ring-ash-900 group-hover:scale-110 transition-transform">
              C
            </div>
        ...
        {/* Login Card */}
        <div className="bg-white dark:bg-ash-900/50 backdrop-blur-xl rounded-3xl border border-ash-200 dark:border-ash-800 shadow-2xl shadow-ash-200/50 dark:shadow-black/50 overflow-hidden animate-in fade-in zoom-in-95 duration-500 delay-150">
          <div className="p-8 md:p-10">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 bg-ash-900 dark:bg-white text-white dark:text-black font-bold rounded-2xl shadow-xl shadow-ash-900/10 dark:shadow-white/5 hover:bg-ash-800 dark:hover:bg-ash-100 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:active:scale-100"
              >
                {isLoading ? (
